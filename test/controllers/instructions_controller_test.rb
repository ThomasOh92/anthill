...
class InstructionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instruction" do
    assert_difference('Instruction.count') do
      post instructions_url, params: { instruction: { caption: @instruction.caption, project_id: @instruction.project_id } }
    end
  ...
  test "should update instruction" do
    patch instruction_url(@instruction), params: { instruction: { caption: @instruction.caption, project_id: @instruction.project_id } }
